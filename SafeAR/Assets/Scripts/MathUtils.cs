...
//                 "Squeeze with jagged arrays is not supported in .NET Standard 1.4."
//             );
// #else
...
//     ///   (row-major, c-style order).</param>
//     ///
//     public static Array Reshape(
//         this Array array,
//         int[] shape,
//         MatrixOrder order = MatrixOrder.CRowMajor
//     )
//     {
//         Type t = array.GetInnerMostType();
...
//                 dimension: dimension,
//                 index: i,
//                 value: Get(source, dimension: dimension, index: indices[i])
//             );
...
//                 "Retrieving dimensions higher than zero has not been implemented"
...
//         Buffer.BlockCopy(
//             source,
//             start * rowSize * Marshal.SizeOf(type),
//             r,
//             0,
